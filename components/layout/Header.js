...
function Header() {
  ...
  const fetchBalance = async () => {
    try {
      ...
      const balance2 = await Moralis.Web3API.account.getNativeBalance(options);
      setBalance(balance2?.balance);
    } catch {}
  };
  React.useEffect(() => {
    fetchBalance();
            ...
            <div className="col-xxl-12 d-flex justify-content-between align-items-center">
              <div className="brand-logo">
                <Link href="/">
                  <img
                    ...
                    srcSet="./images/martex@3x.png 3x, ./images/martex@2x.png 2x, ./images/martex.png 1x"
                    alt=""
                    width="30"
                  />
                </Link>
              ...
              <div className="header-content">
                <div className="header-right">
                  ...
                  {user && (
                    <span>
                      &nbsp;Avalible Coin: <strong>{balance}</strong>
                    </span>
                  )}
                  {/* </button> */}
