...
const chain = process.env.NEXT_PUBLIC_MORALIS_POLYGON;
...
function Balance({ investmentData }) {
    ...
    const fetchWalletBalances = async () => {
        ...
        if (isAuthenticated) {
            ...
            tokensBalance = await Web3Api.account.getTokenBalances(options);
        }
    ...
    useEffect(() => {
        fetchWalletBalances().then((tokensBalance) => {
    ...
    return (
        <>
            <Layout
                headTitle="Wallet"
                pageTitle="Wallet"
                pageTitleSub={"Welcome NFT Wallet page"}
                pageClass={"dashboard"}
                parent={"Home"}
                child={"Wallet"}
            >
                    ...
                    <div className="col-xxl-6 col-xl-6 col-lg-6">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <BalanceDetails balances={tokensBalances} />
                            </div>
                        </div>
                    </div>
                    <div className="col-xxl-6 col-xl-6 col-lg-6">
